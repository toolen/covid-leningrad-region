...
URL = os.getenv("SCRAPER_URL", "http://localhost:8888/page.html")
DB_URI = os.getenv(
    "SCRAPER_DB_URI",
...
DEFAULT_FROM_EMAIL = avoid_empty_value(
    os.getenv("SCRAPER_DEFAULT_FROM_EMAIL", "scraper@local.dev")
)
ADMIN_EMAIL = avoid_empty_value(os.getenv("SCRAPER_ADMIN_EMAIL", "admin@local.dev"))
